...
static xla::DynamicParameterBinding::Target Convert_dynamic_parameter_target(
    mlir::mhlo::DynamicParameterTarget target) {
  switch (target) {
    ...
    case mlir::mhlo::DynamicParameterTarget::OUTPUT:
      ...
      break;
    default:
      assert(false && "Unknown mhlo DynamicParameterTarget");
      break;
  }
  return xla::DynamicParameterBinding::Target::kParam;
}
